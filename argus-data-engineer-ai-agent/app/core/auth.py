...
Shares the same JWT token format as argus-catalog-server so that a single
login session works across both services.
"""
...
async def _get_jwks() -> dict:
    ...
    if cached:
        return cached
    jwks_uri = f"{_keycloak_base_url()}/protocol/openid-connect/certs"
