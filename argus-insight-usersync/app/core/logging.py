...
class _DailyFileHandler(TimedRotatingFileHandler):
    """Daily rotating file handler that produces usersync_YYYYMMDD.log suffixes."""
    ...
    def _namer(self, default_name: str) -> str:
        """Rename rolled file from usersync.log.20260315 to usersync_20260315.log."""
...
def setup_logging() -> None:
    ...
    - Console logging for batch job visibility
    ...
    # Console handler (for batch job stdout visibility)
